...
exports.sendRequest = async (config, options, url, body, formData, headers, onCancel) => {
 ...
 * @throws ApiError
 */
exports.request = (config, options) => {
    return new CancelablePromise_1.CancelablePromise(async (resolve, reject, onCancel) => {
        try {
            ...
            if (!onCancel.isCancelled) {
                const response = await exports.sendRequest(config, options, url, body, formData, headers, onCancel);
